...
use App\Http\Controllers\PropertyMarketDataController;
use App\Http\Controllers\ReportController;
use App\Http\Controllers\RentRollEntryController;
...
Route::middleware(['auth', 'role:admin,staff'])->group(function () {
    ...
    Route::get('/properties/{property:slug}/market-data/create', [PropertyMarketDataController::class, 'create'])->name('properties.market-data.create');
    Route::post('/properties/{property:slug}/market-data', [PropertyMarketDataController::class, 'store'])->name('properties.market-data.store');
    Route::get('/properties/{property:slug}/market-data/{marketDataEntry}/edit', [PropertyMarketDataController::class, 'edit'])->name('properties.market-data.edit');
    Route::put('/properties/{property:slug}/market-data/{marketDataEntry}', [PropertyMarketDataController::class, 'update'])->name('properties.market-data.update');
    Route::delete('/properties/{property:slug}/market-data/{marketDataEntry}', [PropertyMarketDataController::class, 'destroy'])->name('properties.market-data.destroy');
    Route::get('/properties/{property:slug}/rent-roll/create', [RentRollEntryController::class, 'create'])->name('properties.rent-roll.create');
    Route::post('/properties/{property:slug}/rent-roll', [RentRollEntryController::class, 'store'])->name('properties.rent-roll.store');
    Route::get('/properties/{property:slug}/rent-roll/{rentRollEntry}/edit', [RentRollEntryController::class, 'edit'])->name('properties.rent-roll.edit');
    Route::put('/properties/{property:slug}/rent-roll/{rentRollEntry}', [RentRollEntryController::class, 'update'])->name('properties.rent-roll.update');
    Route::delete('/properties/{property:slug}/rent-roll/{rentRollEntry}', [RentRollEntryController::class, 'destroy'])->name('properties.rent-roll.destroy');
